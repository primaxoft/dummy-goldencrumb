    ...
    <section className="bg-primary-100 flex flex-col gap-8 px-4 py-6">
      <div className="flex flex-col gap-4">
        ...
        <p className="text-justify text-lg leading-[1.5rem] font-bold text-neutral-800">
          From crusty sourdough to buttery croissants and locally inspired treats, every item on our menu is handcrafted
          with care and passion. Take a peek at our signature bakes — made fresh every day, just for you.
        </p>
      </div>
